...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_Image, 0, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.pushButton_Before, 1, 1, 1, 1)
